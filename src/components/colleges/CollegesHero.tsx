    ...
    <section className="w-full flex justify-center py-10 lg:py-20 px-4 md:px-10">
      <div className="max-w-7xl w-full flex flex-col-reverse lg:flex-row gap-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-6 text-left">
          <div className="inline-flex items-center gap-2 self-start rounded-full bg-brand-light border border-brand-green/20 px-3 py-1 shadow-sm">
        ...
        <div className="flex-1 w-full">
          <div className="relative aspect-square w-full rounded-[2.5rem] overflow-hidden shadow-soft bg-brand-light border border-brand-blue/10 p-2 group">
            <div className="relative w-full h-full rounded-[2rem] overflow-hidden">
                ...
                {/*<div className="absolute bottom-10 left-6 right-6 md:left-10 md:right-10 bg-brand-light/95 backdrop-blur-md border border-brand-light/60 rounded-2xl p-6 shadow-xl">
